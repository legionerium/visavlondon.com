<?php
require_once('../../_alsitesrc/mailoknovisa.php');
...
InnSendMail($mailto,$subject,$message)
...
//	echo '<br>error';
	$descr =     "Resource "."visa.oknovlondon.com"."\r\n".    
		"дата ".$timestamp."\r\n".
...
//	echo '<br>error2';
	...
	{
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://ovl.oknovlondon.com/ovl/inn_SpecialAddCall.php');
...
InnSendMail('it@inneti.com','__test '.$subject,$message."<br>\r\n".$descr."<br>\r\n".$inn_reg_call, $headers);
